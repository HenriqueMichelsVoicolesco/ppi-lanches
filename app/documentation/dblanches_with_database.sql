...
ALTER TABLE `registros`
  ADD CONSTRAINT `FK_ALUNOS_REGISTROS` FOREIGN KEY (`matricula_aluno`) REFERENCES `alunos` (`matricula`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_TURMAS_REGISTROS` FOREIGN KEY (`turma_aluno`) REFERENCES `turmas` (`id_turma`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
